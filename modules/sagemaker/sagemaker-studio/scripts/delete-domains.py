...
if __name__ == '__main__':
    ...
    parser.add_argument("-r", "--region", type=str, required=True, help="AWS region for which the domains should be deleted")
    parser.add_argument("-p", "--profile", type=str, required=True, help="AWS profile to use for authentication")
