...
#users = json.loads('[{"policyArn": "arn:aws:iam::aws:policy/AdministratorAccess", "secret": "addf-dataservice-users-kubeflow-users-kf-dgraeber"}, {"policyArn": "arn:aws:iam::aws:policy/AdministratorAccess", "secret": "addf-dataservice-users-kubeflow-users-kf-dgrabs1"}]')
...
CfnOutput(
    ...
    id="metadata",
    value=kf_users_stack.to_json_string(
        {
            "KubeflowUsers": kf_users_stack.kf_users,
